    ...
    if usr_cmd == "/start":
        ...
        if(Config.LAZY_MODE == True):
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("🍿supp⊕r† gr⊕up", url="https://t.me/Shubham_Developer_group"),
                        InlineKeyboardButton("🔊ß⊕†s chαηηεl", url="https://t.me/Shubham_Developer")
                    ],
                    [
                    ...
                    [
                        InlineKeyboardButton("⎝⎝✧✧ ᴡᴀᴛᴄʜ ᴛᴜᴛᴏʀɪᴀʟ ✧✧⎠⎠", url="https://youtube.com/@hackerbhai1")
                    ]]))
        else :
            await cmd.reply_photo(photo=lazy_pic,
                ...
                [
                    [
                        InlineKeyboardButton("⚡️SФUЯCΞ CФDΞS ФF ß⊕Γ",
                                             url="https://github.com/Shubhamdev89/MissRozy")
                    ],
                    [
        ...
        if(Config.LAZY_MODE == True):
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("🍿supp⊕r† gr⊕up", url="https://t.me/Shubham_Developer_group"),
                        InlineKeyboardButton("🔊ß⊕ts Channel", url="https://t.me/Shubham_Developer")
                    ],
                    [
                        InlineKeyboardButton("🤖Aß⊕ut ß⊕t", callback_data="aboutbot"),
                        InlineKeyboardButton("♥️Aß⊕ut Đ€V", callback_data="aboutdevs")
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="ꜱᴏʀʀʏ ꜱɪʀ, ʏᴏᴜ ᴀʀᴇ ʙᴀɴɴᴇᴅ ᴛᴏ ᴜꜱᴇ ᴍᴇ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [Support Group](https://t.me/Shubham_Developer_group).",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="ꜱᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [Support Group](https://t.me/Shubham_Developer_group).",
                    disable_web_page_preview=True
                )
                return
        if(Config.LAZY_MODE == True):
